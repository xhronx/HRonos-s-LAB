# Введите имя компьютера и УЗ администратора для включения доступа Ansible
    $STECOMP = "STE-OKN-FS1.ste.lan"
    $ADMUSER = "ste\adm.s.trifonov"
    $SPASS = ConvertTo-SecureString "p;L'8246" -AsPlainText -force
    $CRED = New-Object System.Management.Automation.PsCredential($ADMUSER,$SPASS)
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$STESESS = New-PSSession -ComputerName $STECOMP -Credential $CRED
Invoke-Command -Session $STESESS -FilePath "C:\Enable-Kerberos.ps1"